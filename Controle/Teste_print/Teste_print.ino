...
void setup()
{
  ...
  {
    white_noise += A_sin*sin(2*PI*f*k/1000.);
  }
  ...
  Serial.println("kTs,input,output");
...
{//timer2 interrupt 8kHz toggles pin 9
  ...
  if(ciclo_absoluto>NUM_CICLOS_ACOMODACAO && !end_ams)
  {
    ...
    Serial.print(",");
    Serial.print(white_noise);
    Serial.print(",");
    Serial.println(out_potenc);
